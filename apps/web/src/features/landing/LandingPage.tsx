        ...
        <div className="lp-kits-head">
          ...
          <div className="lp-cam">
            <svg width="34" height="40" viewBox="0 0 34 40" aria-hidden="true">
              <rect x="2" y="2" width="16" height="10" rx="1.5" fill="#1c3a5e" stroke="#3aa0ff" strokeWidth="1" />
              <line x1="4" y1="4.5" x2="16" y2="4.5" stroke="#3aa0ff" strokeWidth="0.7" />
              <line x1="4" y1="7" x2="16" y2="7" stroke="#3aa0ff" strokeWidth="0.7" />
              <line x1="4" y1="9.5" x2="16" y2="9.5" stroke="#3aa0ff" strokeWidth="0.7" />
              <rect x="9" y="12" width="2" height="26" fill="#8a94a3" />
              <circle cx="20" cy="16" r="5" fill="#12161d" stroke="#f7941d" strokeWidth="1.5" />
              <circle cx="20" cy="16" r="2" fill="#f7941d" />
            </svg>
            <div>
              <b>{t("camT")}</b>
              <div>{t("camD")}</div>
